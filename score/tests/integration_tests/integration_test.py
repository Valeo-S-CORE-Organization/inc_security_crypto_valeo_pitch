...
<<<<<<< HEAD:score/tests/integration_tests/integration_test.py
...
>>>>>>> a55e6c0 (Test: Rename init_softhsm_token to generic init_pkcs11_token):tests/integration_tests/integration_test.py
                ),
